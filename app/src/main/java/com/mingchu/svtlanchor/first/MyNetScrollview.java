 ...
 *
 *
 * @function   重写了一个onTouchEvent里面的一个判断  用来流畅的滑动  但是也是没什么用处
 *
 */
public class MyNetScrollview extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(MyNetScrollview v, int scrollX, int scrollY,
    ...
    public MyNetScrollview(Context context) {
        this(context, null);
    }

    public MyNetScrollview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyNetScrollview(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final MyNetScrollview nsvHost = (MyNetScrollview) host;
